...
description: 双向追溯安全规范与代码——给定一条 ieidev-team:secure-coding 规则，找出代码里哪些函数/类实现/违反它；或给定一段代码，找出关联的安全规范条目。基于 .understand-anything/knowledge-graph.json + kdev:security_rule tag 节点。触发时机：用户说"这条规范在哪实现 / 这段代码涉及哪些安全规范 / 安全规范追溯 / 规范覆盖检查"，或对一段代码做安全审查需要查规范来源时。
---
