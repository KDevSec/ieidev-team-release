...
- `.understand-anything/knowledge-graph.json` 存在并含安全规则节点（即跑过 [`/codegraph-build`](../codegraph-build/SKILL.md)）
- 当前在 git 仓库
...
| 受影响节点 0 但代码动了大量 | 图谱过期，跑 `/codegraph-build` |
